...
public class HighestAndLowestSalary {
	...
	public static void main(String[] args) {
		...
		Map<String, Optional<Employee>> max =emp.stream().collect(Collectors.groupingBy(Employee::getDeptartment, Collectors.maxBy(Comparator.comparing(Employee::getSalary))));
		System.out.println("Highest Salary of Each Department");
		System.out.println(max);
		
		Map<String, Optional<Employee>> min =emp.stream().collect(Collectors.groupingBy(Employee::getDeptartment, Collectors.minBy(Comparator.comparing(Employee::getSalary))));
		System.out.println("Lowest Salary of Each Department");
